...
const variantClasses: Record<ButtonVariant, string> = {
  primary:
    "bg-accent text-vault hover:bg-cream disabled:opacity-50 focus-visible:outline focus-visible:outline-2 focus-visible:outline-offset-2 focus-visible:outline-accent",
  secondary:
...
const sizeClasses: Record<ButtonSize, string> = {
  ...
  lg: "min-h-10 px-5 py-2 sm:min-h-11 sm:px-7 sm:py-2.5",
};
...
export function Button({
  ...
  return (
    <button
      ...
      aria-busy={loading}
      className={[
        "inline-flex items-center justify-center rounded-md font-mono uppercase tracking-button text-xs",
