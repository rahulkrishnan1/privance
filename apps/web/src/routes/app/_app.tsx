...
function AppLayout() {
  ...
  useAuthRedirect({ onUnauthenticated: true, onLocked: true }, navigate);

  // Hold a blank splash until mounted and unlocked: painting the shell before
  // auth resolves from storage flashes the dashboard on a cold launch.
