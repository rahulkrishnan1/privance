  ...
  return (
    ...
    >
      <div className="max-w-[1160px] mx-auto px-8">
        ...
        >
          <Button asChild variant="primary">
            <Link to="/auth/signup">Have an invite?</Link>
          </Button>
...
// Pre-computed static cipher text for the landing marquee.
const CIPHER_CHUNKS = (() => {
  const chunks: string[] = [];
  for (let i = 0; i < 6; i++) {
    let chunk = "";
    ...
    <footer className="pt-20 pb-11 border-t border-line-soft relative overflow-hidden">
      ...
      <div className="max-w-[1160px] mx-auto px-8 relative">
        ...
        <div className="flex justify-center mt-7">
          <Button asChild variant="primary">
            <Link to="/auth/signup">Start with Privance</Link>
          </Button>
        </div>
...
function LandingPage() {
  ...
  useAuthRedirect({ onUnlocked: true, onLocked: true });
